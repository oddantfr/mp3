...
import jishoIcon from './img/jisho.ico?inline';
import translateIcon from './img/translate.ico?inline';
import gooIcon from './img/goo.ico?inline';
import accept from './audio/accept.mp3?inline';
import error from './audio/error.mp3?inline';
import beep from './audio/error.mp3?inline';
...
export const AppAudio = {
	error: new Audio(AudioSrc.error),
	beep: new Audio(AudioSrc.beep),
};
AppAudio.error.volume = 0.6;

export {appLogo};

export const googleGLogoSvg = html`<svg
...
export const googleImagesSvg = html`<svg
	class="DCxYpf"
	focusable="false"
	aria-hidden="true"
	viewBox="0 0 24 24"
